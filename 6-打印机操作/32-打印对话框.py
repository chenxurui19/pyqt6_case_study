# -*- coding: utf-8 -*-
# @Time    : 2023/5/23 17:22
# @Author  : CXRui
# @File    : 32-打印对话框.py
# @Description :
from PyQt6.QtWidgets import QWidget, QApplication, QPushButton, QTextEdit, QFileDialog, QDialog
from PyQt6.QtPrintSupport import QPageSetupDialog, QPrintDialog, QPrinter
import sys
